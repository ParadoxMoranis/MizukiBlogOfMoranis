...
describe("Markdown AST enhancements", () => {
	...
	it("turns standalone wiki links into article cards and inline links", async () => {
		const target = "ClaudeCode原生使用第三方Key";
		const tree = {
			type: "root",
			children: [
				{
		...
		assert.match(tree.children[0].data.hProperties.href, /ClaudeCode/);
