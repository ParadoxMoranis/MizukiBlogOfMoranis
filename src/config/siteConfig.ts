...
export const siteConfig: SiteConfig = {
	...
	siteURL: "https://moranis.blog/",
	siteStartDate: "2025-09-11",
	...
	featurePages: {
		...
		skills: false, // 当前站点未使用模板技能数据
		timeline: false, // 当前站点未使用模板时间线数据
		albums: true, // 相册页面开关
		devices: false,
		aiTools: false,
	},
	...
	postListLayout: {
		...
		// 文章列表页分类导航条配置
		categoryBar: {
			enable: false, // 保持旧版首页布局，不显示分类导航条
		},
	},
	...
	banner: {
		...
		src: {
			desktop: ["/assets/desktop-banner/neo-theme.png"],
			mobile: [
